...
public class DataServiceImpl implements DataService {
    ...
    public List<Project> getAllProject() {
        ...
        if(!user.getRole().getName().equals("Admisrateur"))
    ...
    public void notfication(){
        ...
        JsonObject response = restTemplateClient.getResponseRestTemplate(Uri.getnotifications("/notificationscheme"), HttpMethod.GET);
